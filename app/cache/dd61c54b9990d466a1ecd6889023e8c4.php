1339059536DEXCACHE---><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>招聘60名五月天演唱会兼职销售员 - 三明学院学院网</title>
...
<div class="sitemap">
    <div class="home">
        ...
        <a href="javascript:;">招聘60名五月天演唱会兼职销售员</a>
    </div>
</div>
<!--end sitemap-->
...
<div class="content">
	<div class="con_left">
       	<div class="article">
         	<h2>招聘60名五月天演唱会兼职销售员</h2>
         	<div class="article_by">
           		<span>时间：2012-05-26</span>
           		<span>作者：admin</span>
         	</div>
         	<div class="artcle_con">
				<p>
	&nbsp;</p>
<p style="color: rgb(0, 0, 0); font-family: 微软雅黑; font-size: medium; ">
	销售五月天演唱会周边产品</p>
<p style="color: rgb(0, 0, 0); font-family: 微软雅黑; font-size: medium; ">
	地址：泉州海峡体育中心体育场</p>
<p style="color: rgb(0, 0, 0); font-family: 微软雅黑; font-size: medium; ">
	时间，5月19号上午10点上班，演唱会结束半小时下班</p>
<p style="color: rgb(0, 0, 0); font-family: 微软雅黑; font-size: medium; ">
	工资：底薪100元，包两餐。个人营业额超1000元后，再加10/100的提成。下班开工资</p>
<p style="color: rgb(0, 0, 0); font-family: 微软雅黑; font-size: medium; ">
	要求。做人实在，工作认真，上班时必须携带个人有效身份证或者学生证</p>
<p style="color: rgb(0, 0, 0); font-family: 微软雅黑; font-size: medium; ">
	联系方式：18616093102（孙先生）</p>
                         	</div>
       	</div>
    </div>
    <div class="con_right">
      	<div class="woyao">
        	<a class="fabu" style="float:right;" href="http://local.smc.com/job/add">我要发布</a>
      	</div>
      	<div class="ad">
