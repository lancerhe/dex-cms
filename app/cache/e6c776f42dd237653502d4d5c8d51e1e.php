1339059555DEXCACHE---><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>zip - 三明学院学院网</title>
	...
	<div class="con_left">
       	<div class="article">
         	...
         	<div class="article_by">
           		<span>时间：2012-06-06</span>
           		<span>作者：admin</span>
         	</div>
         	<div class="artcle_con">
				zip                <p><br />附件:</p><a href="/upload/files/20120606112252.zip">点击下载</a>         	</div>
       	</div>
    </div>
    <div class="con_right">
      	<div class="woyao">
        	<a class="fabu" style="float:right;" href="http://local.smc.com/Material/add">我要发布</a>
      	</div>
      	<div class="ad">
