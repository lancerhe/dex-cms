1339059545DEXCACHE---><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>考试材料 - 三明学院学院网</title>
...
<!-- header end --><link rel="stylesheet" href="http://local.smc.com/resources/css/page/exam.css" />
<!--sitemap-->
<div class="sitemap">
    <div class="home">
    	<a href="http://local.smc.com/" >网站首页</a> &gt; <a href="javascript:;" >考试材料</a>
    </div>
</div>
<!--end sitemap-->
...
<div class="content">
	<div class="con_left">
        <div class="ad_right">
            ...
            <img src="http://local.smc.com/resources/images/ad/ad4.gif" />
        </div>

        <div class="shopping">
            <h1 class="cailiao meishi_t"><span style="float:left;">考试材料</span><a href="http://local.smc.com/material/exam" class="more_l">更多...</a></h1>
            <div class="shopping_left">
                <ul>
                                        <li><a href="http://local.smc.com/material/detail/79">zip</a></li>
                                    </ul>
            </div>
      	...
      	<div class="shopping">
        	<h1 class="dengji meishi_t"><span style="float:left;">课后答案</span><a href="http://local.smc.com/material/homework" class="more_l">更多...</a></h1>
        	<div class="shopping_left">
          		<ul>
                                    </ul>
        	</div>
    ...
    <div class="con_right">
        ...
        <div class="ad">
        	<img src="http://local.smc.com/resources/images/ad/ad5.gif" />
        </div>

        <div class="info">
            <h3 class="r_title"><a class="r_title" href="#">热门产品</a></h3>
